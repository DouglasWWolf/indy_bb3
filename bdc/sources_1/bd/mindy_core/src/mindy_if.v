...
//
// 09-Apr-26  DWW     3  Added X_INTERFACE declarations
//=============================================================================
...
(
    ...
    (* X_INTERFACE_PARAMETER = "ASSOCIATED_BUSIF AXIS_FD_IN:AXIS_FD_OUT:AXIS_MD_IN:AXIS_MD0_OUT:AXIS_MD1_OUT, ASSOCIATED_RESET resetn" *)
    input   clk,
    input   resetn,
